...
export class IndexComponent implements OnInit {
  @ViewChild('makeFormModel', { static: false }) makeFormModel: RequestademomodelComponent;
  ...
  imageObject = [{
    ...
    thumbImage: 'assets/img/brand-1.png',
}, {
    image: 'assets/img/brand-2.png',
    thumbImage: 'assets/img/brand-2.png'
}, {
    image: 'assets/img/brand-3.png',
    thumbImage: 'assets/img/brand-3.png',
},{
    image: 'assets/img/brand-4.png',
    thumbImage: 'assets/img/brand-4.png',
}, {
    image: 'assets/img/brand-5.png',
    thumbImage: 'assets/img/brand-5.png'
}];
