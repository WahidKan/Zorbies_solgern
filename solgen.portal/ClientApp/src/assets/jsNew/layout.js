...
//      setTimeout(function () {
//        $('body').addClass('sidebar-collapsed'); $('.topbar').css({ width: ViewPortwidth });
//        $('.main-content .page-content').css({ width: ViewPortwidth - 50 });
     
//        $('.actions').addClass('smview');
//        $('.btn-success').addClass('smview');
//        $('.text-success ').addClass('smview');
//      },
//        500);
//      $('.actions').addClass('smview');
//      $('.btn-success').addClass('smview');
...
$(document).on("click", ".smview", function () {
  var ViewPortwidth = $(window).width();
  if (ViewPortwidth < 1367 && ViewPortwidth > 1024) {
    setTimeout(function () {
      $('body').addClass('sidebar-collapsed');
...
function fixAccordianHeight() {
  const margin = ($("#accordion .panel").length == 1) ? 350 : 200;
  const maxheight = ($(window).height() - margin) / $("#accordion .panel").length;

  var finalHeight = "max-height:" + maxheight + "px !important;overflow:auto;";
  $("#accordion .panel").find('ul').removeAttr("style");
  $("#accordion .panel").find('ul').attr("style", finalHeight);
};
...
$('body').on('click', '.panel-title', function () {
  $("#accordion.panel-group .panel").removeClass("active");
