...
$(document).on('mouseover', "#ulili", function () {
  //console.log(this);
  $(this).addClass("nav-hover");

});
$(document).on('mouseout', "#ulili", function () {
  $(this).removeClass("nav-hover");
});

$(document).on('click', "#menutoggleid", function () {
...
//setTimeout(function () { createSideScroll }, 6000);
...
function toggleSidebarMenu() {
  ...
  $('body').on('click', '.sidebar .nav-sidebar li.nav-parent > a', function (e) {
        e.preventDefault();
...
//var hoverTimeout;
//$('body').on('mouseover', '.nav-sidebar > li', function (e) {
...
//$('body').on('mouseover', '.nav-sidebar > li .children', function (e) {
...
$(document).ready(function() {
  ...
  //$(".menutoggle a").live('click', function (e) {
  //  alert(1);
  //  event.preventDefault();
  //  if ($('body').hasClass('sidebar-collapsed') || $('body').hasClass('sidebar-top') || $('body').hasClass('submenu-hover'))
  //    $('.nav-sidebar .children').css({
...
$('body').on('show.bs.collapse', '#accordion', function (e) {
  $(e.target).prev('.card-header').parent('.card').removeClass('rotate');
 
});
$('body').on('hide.bs.collapse', '#accordion', function (e) {
  $(e.target).prev('.card-header').parent('.card').addClass('rotate');
