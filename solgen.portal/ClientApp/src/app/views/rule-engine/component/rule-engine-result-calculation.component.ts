...
@Component({
  selector: 'app-rule-engine-result-calculation',
  templateUrl:'./rule-engine-result-calculation.component.html'
})
export class RuleEngineResultCalculationComponent implements OnInit, OnChanges {
