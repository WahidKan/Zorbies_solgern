...
@Component({
  selector: 'app-contract-mapping',
  templateUrl: './contract-mapping.component.html',
  styleUrls: ['./contract-mapping.component.scss']
})
export class ContractMappingComponent implements OnInit {


  @ViewChild('contractmappingModal', { static: false }) contractmappingModal: ModalDirective;  //#replyNotesmodel
  ...
  ngOnInit() {
    ...
    this.route.paramMap.subscribe(
      params => {
        ...
        if (this.commonService.getQueryStringValue("contract") != null)
          id = this.commonService.getQueryStringValue("contract");
        if (opid != null)
    ...
    ;
    this.contractService.GetCustomFieldsList(this.moduleName, this.submoduleName, this.companyId, this.Id, this.OpportunityId, this.displayType).subscribe((result: any) => {
      if (result) {
      ...
      this.onCustomChange(this.OpportunityId);
    });
      ...
      this.contractService.addEditForm(this.JsonData).subscribe((result: any) => {
        ...
        if (result.statusCode == 200) {
          ...
          setTimeout(() => {
            ...
            this.contractmappingModal.hide();
  ...
  show(id?: any) {
    ...
    if (id) {
      ...
      this.displayType = 'EDIT';
      this.ngOnInit()
      this.contractmappingModal.show();
    }
    else {
