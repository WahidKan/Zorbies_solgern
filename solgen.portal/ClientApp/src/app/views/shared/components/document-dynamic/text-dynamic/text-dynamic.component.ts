...
@Component({
  selector: "app-text-dynamic",
  templateUrl: "./text-dynamic.component.html",
  styleUrls: ["./text-dynamic.component.scss"],
  encapsulation: ViewEncapsulation.None,
})
export class TextDynamicComponent implements OnInit, OnDestroy {
  ...
  onTextBoxChanged(event: any){
    this.textBox.get('fieldName').setValue(event.target.innerHTML);
  }
}
