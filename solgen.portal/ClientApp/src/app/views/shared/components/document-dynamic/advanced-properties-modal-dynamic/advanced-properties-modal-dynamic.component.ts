...
@Component({
  selector: 'app-advanced-properties-modal-dynamic',
  templateUrl: './advanced-properties-modal-dynamic.component.html',
  styleUrls: ['./advanced-properties-modal-dynamic.component.scss']
})
export class AdvancedPropertiesModalDynamicComponent implements OnInit {
