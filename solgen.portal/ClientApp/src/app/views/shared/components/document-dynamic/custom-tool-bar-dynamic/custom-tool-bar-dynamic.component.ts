...
@Component({
  selector: 'app-custom-tool-bar-dynamic',
  templateUrl: './custom-tool-bar-dynamic.component.html',
  styleUrls: ['./custom-tool-bar-dynamic.component.scss']
})
export class CustomToolBarDynamicComponent implements OnInit, OnDestroy {
