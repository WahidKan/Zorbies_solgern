...
@Component({
  selector: 'app-solgen-queue-input',
  templateUrl: './solgen-queue-input.component.html',
  styleUrls: ['./solgen-queue-input.component.scss']
})
export class SolgenQueueInputComponent implements OnInit {
