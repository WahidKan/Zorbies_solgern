...
@Component({
  selector: 'solgen-input',
  templateUrl: './solgen-input.component.html',
  styleUrls: ['./solgen-input.component.scss']
})
export class SolgenInputComponent implements OnInit, OnChanges{
