...
@Component({
  selector: 'app-creditcheckscore',
  templateUrl: './creditcheckscore.component.html',
  styleUrls: ['./creditcheckscore.component.scss']
})
export class CreditcheckscoreComponent implements OnInit {
  @ViewChild('leaseContactCreditScoreModal', { static: false }) modalContactCreditScore: ModalDirective;
...
contactId :any;
  ...
  contactName: string;
  constructor(private leaseService: ManageleaseService, private documentList: UploadComponent, private fb: FormBuilder, private toaster: ToastrService,
  ...
  close() {
    ...
    this.modalContactCreditScore.hide();
  ...
  private prepareFormDataForDocument() {
    ...
    input.append('LeaseId', this.contactId);
    ...
    input.append('ContactName', this.contactName);
  ...
  show(userId, contactId, config, prefixNameOfDocument) {
    this.UserId = userId;
    this.contactName = prefixNameOfDocument
    this.contactId = contactId;
    this.config = config;
    this.modalContactCreditScore.show();
    this.active = true;
  }
