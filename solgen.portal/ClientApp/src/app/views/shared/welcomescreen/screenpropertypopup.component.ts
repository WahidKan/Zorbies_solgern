...
@Component({
  selector: 'app-screenpropertypopup',
  templateUrl: './screenpropertypopup.component.html',
  styleUrls: ['./screenpropertypopup.component.scss']
})
export class ScreenpropertypopupComponent implements OnInit {
