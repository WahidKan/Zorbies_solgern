...
export class SolgenRuleEngineService {
  ...
  getRuleEnginFormulaList(params): Observable<any> {
    return this.http.get(`${this.baseUri}RuleEngineFormula/GetRuleEngineList`, {
      params: {
  ...
  GetDynamicReportFieldsListBySubModuleId(moduleId: any, subModuleId: any, subModuleCode:any) {
    return this.http.get(`${this.baseUri}SolgenRuleEngine/GetDynamicReportFieldsListBySubModuleId?moduleId=${moduleId}&subModuleId=${subModuleId}&subModuleCode=${subModuleCode}`);
  }
  ...
  buildFormulaCondition(condition = null) {
    ...
    if (condition != null) {
      ...
      formulaCondition.patchValue({
        ...
        ruleTargetResultConditionId: condition.ruleTargetResultConditionId,
        ruleTargetResultId: condition.ruleTargetResultId,
