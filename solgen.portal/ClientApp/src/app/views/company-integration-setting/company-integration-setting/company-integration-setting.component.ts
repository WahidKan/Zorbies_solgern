...
import { JsonData, LocationService, CheckboxData, CheckLocationName } from '../../location/locationlist.service';
import { ModalDirective } from 'ngx-bootstrap';
import { CommonService } from '../../shared/common.service';
import { ActivatedRoute, Router } from '@angular/router';
import { CompanyIntegrationSettingService, SettingJsonData } from '../company-integration-setting.service';
import { ScriptService } from '../../shared/scriptservice.service';


declare var google: any;
@Component({
  selector: 'app-company-integration-setting',
  templateUrl: './company-integration-setting.component.html',
  styleUrls: ['./company-integration-setting.component.scss']
})
export class CompanyIntegrationSettingComponent implements OnInit {
  ...
  group_id: any;
  moduleName = 'settings';
  submoduleName = 'companyintegrationsetting';
  group_name: any;
  ...
  JsonData: SettingJsonData = new SettingJsonData();
  userId: any;
  ...
  constructor(private fb: FormBuilder, private companyIntegrationSettingService: CompanyIntegrationSettingService, private router: Router,
    private toaster: ToastrService, private route: ActivatedRoute, private commonService: CommonService, private dynamicScripts: ScriptService) {
...
this.dynamicScripts.load('map');
  ...
  ngOnInit() {
    ...
    this.route.paramMap.subscribe(
      params => {
        ...
        if (id) {
          ...
          this.pageTitle = 'Company Integration Settings';
    ...
    this.companyIntegrationSettingService.GetCompanyIntegrationSettingList(this.moduleName, this.submoduleName, this.displayType).subscribe((result: any) => {
      ;
      if (result) {
        this.customCompnentValues = this.companyIntegrationSettingService.customFieldsList.data;
...
isReadOnly(param){
  ...
  onSubmit() {
    ...
    if (this.form.valid) {
      ...
      this.companyIntegrationSettingService.addEditForm(this.JsonData).subscribe((result: any) => {
...
//     //   this.JsonData.FormJsonData = JSON.stringify(this.form.value);
//     //   this.companyIntegrationSettingService.GetLocationNameAlreadyExist(this.appmodel).subscribe((result: any) => {
