...
import { CheckboxData, CommonService, dynamicsectionarray, MarkAsCompleteData, StageData,fieldsJson } from '../../shared/common.service';

@Component({
  selector: 'app-mobile-views-statemangement',
  templateUrl: './mobile-views-statemangement.component.html',
  styleUrls: ['./mobile-views-statemangement.component.scss']
})
export class MobileViewsStatemangementComponent implements OnInit {
  ...
  closedetailform() {
    console.log(this.stagedatamaster);
    //this.showDetailDiv = true;
    this.stagedatamaster.forEach(m => {
