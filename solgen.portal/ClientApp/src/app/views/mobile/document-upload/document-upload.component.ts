...
import { ToastrService } from 'ngx-toastr';
import { LoanapplicationserviceService, loansectionarray, reasonModel, BankerModel, LoanProgressModel, Progress } from '../../loanapplication/loanapplicationservice.service';
...
import { NotificationpopupComponent } from '../../loanapplication/notifications/notificationpopup/notificationpopup.component';
import { StageinfoComponent } from '../../loanapplication/stageinfo/stageinfo.component';
import { DownloaddocumentComponent } from '../../loanapplication/downloaddocument/downloaddocument.component';
import { ExpansesComponent } from '../../loanapplication/expanses/expanses.component';
import { CommenthistoryComponent } from '../../loanapplication/commenthistory/commenthistory.component';
import { NotesComponent } from '../../loanapplication/notes/notes.component';
import { TransferloanapplicationComponent } from '../../loanapplication/transferloanapplication/transferloanapplication.component';
import { LoandocsComponent } from '../../loanapplication/loandocs/loandocs.component';
import { CreditReportComponent } from '../../loanapplication/credit-report/credit-report.component';
import { environment } from 'src/environments/environment';
import { RuleenginehistoryComponent } from '../../loanapplication/ruleEngineHistory/ruleenginehistory.component';
import { ChangeorderComponent } from '../../loanapplication/changeorder/changeorder.component';
import { TranfertodealerComponent } from '../../loanapplication/tranfertodealer/tranfertodealer.component';
import { SystemInfoComponent } from '../../loanapplication/systeminfo/systeminfo.component';
...
imageLink = '../../assets/images/default-user-icon.jpg';
  ...
  ngOnInit() {
    ...
    this.loanDataId = this.loanapplicationservice.loanId
    if (this.loanDataId) {
      this.GetLoanapplicationDocumentType(this.loanDataId)
    }

    this.submoduleCodeId = this.loanapplicationservice.mobileSubmoduleId;
    if (this.submoduleCodeId) {
      this.getImages();
    }
    ...
    // this.loanDataId = 
    // this.GetLoanapplicationDocumentType('3350')
    ...
    if(this.loanId){
          ...
          this.GetLoanApplicationSales_Rep(this.loanId);
          //this.refresh();
          this.loadSave = false;
    ...
    this.loanapplicationservice.GetApplicationDetails(id, this.companyId, this.userId).subscribe((result: any) => {
      ...
      this.loanapplicationservice.GetStageDetails(id).subscribe((result: any) => {
        ...
        this.formstagedata.forEach((item1) => {
          ...
          // }
          if ((item1.loan_app_stage_name == "Loan Product" || item1.loan_app_stage_name == "Product Info" || item1.loan_app_stage_name == "Document Signed" || item1.loan_app_stage_name == "Internal Verification") && item1.stageActive == 1 && (this.ApplicationStatus === 'Failed' || this.ApplicationStatus === 'Pending Documents')) {
  ...
  getImages() {
    this.leadservice.getImages(this.loanDataId, this.submoduleCodeId).subscribe((result: any) => {
