...
import { GroupControls, LayoutControlModel, Group } from '../managelayout/layout.service';
...
export class FormbuilderComponent implements OnInit {
  @ViewChild('properties', { static: false}) properties: PropertiespopupComponent;
  ...
  constructor(private fb: FormBuilder, private formmasterService: FormmasterService, private router: Router,
  ...
  getcustomfielddata(id, sid) {
    ...
    this.formmasterService.GetCustomFieldsList(id, this.companyId).subscribe((result: any) => {
      if (result) {
        ...
        this.customFiledsData = this.formmasterService.customFieldsList.data;
  ...
  AddLayoutForCustomField() {
    if (this.manageLayout.valid) {
      ...
      this.formmasterService.SaveLAyourData(this.group, this.formid).subscribe((result: any) => {
