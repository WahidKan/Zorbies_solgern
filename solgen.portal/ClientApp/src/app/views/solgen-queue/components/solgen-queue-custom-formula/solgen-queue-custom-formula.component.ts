...
@Component({
  selector: 'app-solgen-queue-custom-formula',
  templateUrl: './solgen-queue-custom-formula.component.html',
  styleUrls: ['./solgen-queue-custom-formula.component.scss']
})
export class SolgenQueueCustomFormulaComponent implements OnInit {
  ...
  saveFormula(){
    this.service.buildTargetResultConditionRelatedFormulaDatabaseString(this.formulaForm.value,this.resultform);
    this.hide();
  }
