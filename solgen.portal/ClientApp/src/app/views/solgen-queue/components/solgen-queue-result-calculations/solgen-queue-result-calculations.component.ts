...
@Component({
  selector: 'app-solgen-queue-result-calculations',
  templateUrl: './solgen-queue-result-calculations.component.html',
  styleUrls: ['./solgen-queue-result-calculations.component.scss']
})
export class SolgenQueueResultCalculationsComponent implements OnInit {
