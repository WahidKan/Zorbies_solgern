...
import { SolgenQueueCustomFormulaComponent } from '../solgen-queue-custom-formula/solgen-queue-custom-formula.component';
@Component({
  selector: 'app-solgen-queue-result-fields',
  templateUrl: './solgen-queue-result-fields.component.html',
  styleUrls: ['./solgen-queue-result-fields.component.scss']
})
export class SolgenQueueResultFieldsComponent implements OnInit {
  ...
  operators: any = [];
  @ViewChild("resultCalculationModal", { static: false }) resultCalculation: SolgenQueueConditionCalculationsComponent;
  @ViewChild("formulaModal", { static: false }) formulaModal: SolgenQueueCustomFormulaComponent;
  ...
  addTableField() {
    this.tableFields.push(this.service.buildResultTableField(null));
  }
